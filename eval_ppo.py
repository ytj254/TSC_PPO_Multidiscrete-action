...
def test():
    # Best model
    model_path = 'models/PPO-2023-06-15_3/best_model.zip'
    model = PPO.load(model_path)
    stats_path = 'models/PPO-2023-06-15_3/best_vec_normalize.pkl'

    # Final model
    # model_path = 'models/PPO-2023-06-15_3/final_model.zip'
    # model = PPO.load(model_path)
    # stats_path = 'models/PPO-2023-06-15_3/vec_normalize.pkl'
